package com.udemy.spring.spring.selenium.window;

import com.udemy.spring.spring.selenium.SpringBaseTestNGTest;
import com.udemy.spring.spring.selenium.page.window.MainPage;
import com.udemy.spring.spring.selenium.page.window.PageA;
import com.udemy.spring.spring.selenium.page.window.PageB;
import com.udemy.spring.spring.selenium.page.window.PageC;
